...
check "generation is static and externally independent" "grep -q 'static source-completion tasks' skills/project-generation-workflow/SKILL.md && grep -q 'trigger, rerun, retry, dispatch, approve, cancel, or wait for CI' skills/project-generation-workflow/SKILL.md && grep -q 'CI triggered, cancelled, or awaited: `none`' skills/project-generation-workflow/SKILL.md"

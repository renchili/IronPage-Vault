...
check "air-gapped deployment scope" "test ! -e deploy/aws && test ! -e docs/aws-deployment.md && ! grep -RInE 'AWS|EKS|Lambda|CloudFormation' README.md docs ci scripts tests"

...
- README uses short examples where they clarify correct documentation style.
- languages, data languages, platforms, and project type were detected before generation.
- each detected language or technology is described by actual role, not file extension alone.

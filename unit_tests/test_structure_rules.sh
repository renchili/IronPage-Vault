...
check "backup restore consumes returned artifact paths" "grep -q 'DB_DUMP_PATH=.*database_dump_path' API_tests/test_admin_ops.sh && grep -q 'FILE_SNAPSHOT_PATH=.*file_snapshot_path' API_tests/test_admin_ops.sh"
